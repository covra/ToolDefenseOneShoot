...
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects1= [];
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects2= [];
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects3= [];
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects4= [];
gdjs.LoginHyplayCode.GDspr_9595coverObjects1= [];
gdjs.LoginHyplayCode.GDspr_9595coverObjects2= [];
gdjs.LoginHyplayCode.GDspr_9595coverObjects3= [];
gdjs.LoginHyplayCode.GDspr_9595coverObjects4= [];
...
gdjs.LoginHyplayCode.asyncCallback17675852 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LoginHyplayCode.asyncCallback17675852(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.LoginHyplayCode.GDtxt_9595nfoObjects2.length ;i < len;++i) {
    gdjs.LoginHyplayCode.GDtxt_9595nfoObjects2[i].getBehavior("Text").setText("Welcome Guest");
}
}
{ //Subevents
gdjs.LoginHyplayCode.eventsList0(runtimeScene);} //End of subevents
}
...
};gdjs.LoginHyplayCode.userFunc0x446f4d8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.LoginHyplayCode.userFunc0x446f4d8(runtimeScene, objects);
...
gdjs.LoginHyplayCode.eventsList2(runtimeScene);
}


};gdjs.LoginHyplayCode.asyncCallback17687884 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
gdjs.LoginHyplayCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__AdvancedHTTP__ExecuteRequest.func(runtimeScene, "HYPLAYGetUser", runtimeScene.getScene().getVariables().getFromIndex(0), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.LoginHyplayCode.asyncCallback17687884(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoginHyplayCode.eventsList6 = function(runtimeScene) {
...
{ //Subevents
gdjs.LoginHyplayCode.eventsList5(runtimeScene);} //End of subevents
}

}


};gdjs.LoginHyplayCode.userFunc0x4478988 = function GDJSInlineCode(runtimeScene) {
"use strict";
setTimeout(()=>{
    ...
    runtimeScene.requestChange(gdjs.RuntimeScene.REPLACE_SCENE, "MenuMap");
    
},250);
};
gdjs.LoginHyplayCode.eventsList7 = function(runtimeScene, asyncObjectsList) {
...
gdjs.LoginHyplayCode.userFunc0x4478988(runtimeScene);

}


};gdjs.LoginHyplayCode.asyncCallback17688948 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
{gdjs.evtTools.debuggerTools.log("Response from hyplay: " + runtimeScene.getScene().getVariables().getFromIndex(0).getAsString(), "info", "");
}
{ //Subevents
gdjs.LoginHyplayCode.eventsList7(runtimeScene, asyncObjectsList);} //End of subevents
gdjs.LoginHyplayCode.localVariables.length = 0;
}
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__AdvancedHTTP__ReadResponseJSON.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(0), runtimeScene.getScene().getVariables().getFromIndex(3), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.LoginHyplayCode.asyncCallback17688948(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17677788);
}
}
if (isConditionTrue_0) {
...
gdjs.LoginHyplayCode.eventsList6(runtimeScene);
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(17688252);
}
}
if (isConditionTrue_0) {

{ //Subevents
gdjs.LoginHyplayCode.eventsList8(runtimeScene);} //End of subevents
}

}


};gdjs.LoginHyplayCode.asyncCallback17742580 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.LoginHyplayCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LoginHyplayCode.asyncCallback17742580(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.LoginHyplayCode.eventsList11(runtimeScene);
}
...
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects1.length = 0;
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects2.length = 0;
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects3.length = 0;
gdjs.LoginHyplayCode.GDtxt_9595nfoObjects4.length = 0;
gdjs.LoginHyplayCode.GDspr_9595coverObjects1.length = 0;
gdjs.LoginHyplayCode.GDspr_9595coverObjects2.length = 0;
gdjs.LoginHyplayCode.GDspr_9595coverObjects3.length = 0;
gdjs.LoginHyplayCode.GDspr_9595coverObjects4.length = 0;
